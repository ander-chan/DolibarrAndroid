...
import co.medicamecanica.restclient.login.Login;
import co.medicamecanica.restclient.login.LoginResource;
import co.medicamecanica.restclient.login.ResponseError;
